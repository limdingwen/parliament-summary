...
CREATE TABLE IF NOT EXISTS "public"."debate_speech" (
    ...
    "order_no" bigint NOT NULL,
    "speaker_name" "text",
    "fill_debate_speaker_ids_updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
ALTER TABLE ONLY "public"."debate"
    ADD CONSTRAINT "debate_bill_id_fkey" FOREIGN KEY ("bill_id") REFERENCES "public"."bill"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."debate_speech"
    ADD CONSTRAINT "debate_speech_speaker_id_fkey" FOREIGN KEY ("speaker_id") REFERENCES "public"."mp"("id") ON UPDATE CASCADE ON DELETE SET NULL;
